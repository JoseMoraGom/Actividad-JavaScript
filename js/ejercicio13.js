...
function procesarCadenas()
{
    ...
    var NOMBRE=nombre+" "+apellidos; // <-- SUSTITUYE AQUÍ TU CÓDIGO
    console.log('NOMBRE: '+NOMBRE);
    document.getElementById("fullName").innerHTML=NOMBRE.toUpperCase();

    // Convertimos el NOMBRE a minusculas
    console.log('nombre: '+NOMBRE.toUpperCase()); // <-- CORRIGE ESTE CÓDIGO
    ...
    document.getAnimations("fullNameHTML").innerHTML=fullName+" ("+longitudFull+")";
    ...
    var nuevoNombre="Por ejemplo: Antonio"; // <-- CORRIGE Y COMPLETA EL CÓDIGO
    document.getElementById("nombre").placeholder=nuevoNombre;
